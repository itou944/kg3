...
const initialState = {
  availableKeyGuns: [
    ...
    { id: 3, name: 'Slack', icon: '/api/placeholder/48/48', category: 'Communication' },
    { id: 4, name: 'Jira', icon: '/api/placeholder/48/48', category: 'Project Management' },
    { id: 5, name: 'Docker', icon: '/api/placeholder/48/48', category: 'DevOps' },
    { id: 6, name: 'Kubernetes', icon: '/api/placeholder/48/48', category: 'DevOps' },
    { id: 7, name: 'AWS', icon: '/api/placeholder/48/48', category: 'Cloud Services' },
    ...
    { id: 9, name: 'Stack Overflow', icon: '/api/placeholder/48/48', category: 'Knowledge Base' },
    { id: 10, name: 'Postman', icon: '/api/placeholder/48/48', category: 'API Testing' },
    { id: 11, name: 'Jenkins', icon: '/api/placeholder/48/48', category: 'CI/CD' },
    { id: 12, name: 'Notion', icon: 'https://upload.wikimedia.org/wikipedia/commons/e/e9/Notion-logo.svg', category: 'Documentation' },
    { id: 13, name: 'Figma', icon: '/api/placeholder/48/48', category: 'Design' },
    { id: 14, name: 'Trello', icon: '/api/placeholder/48/48', category: 'Project Management' },
    { id: 15, name: 'GitLab', icon: '/api/placeholder/48/48', category: 'Version Control' },
  ],
  selectedKeyGuns: [],
};
